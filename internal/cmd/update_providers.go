...
kuroryuu update-providers https://example.com/providers.json
...
kuroryuu update-providers --source=hyper

# Update Hyper from a custom URL
kuroryuu update-providers --source=hyper https://hyper.example.com
`,
